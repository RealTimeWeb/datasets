...
class _Constants(object):
    _HEADER = {'User-Agent': 
              'CORGIS Johnson Grass library for educational purposes'}
...
_Constants._DATABASE_NAME = "johnsongrass.db"
...
def get_johnsongrass():
    ...
    if False:
        ...
        rows = _Constants._DATABASE.execute("SELECT data FROM johnsongrass".format(
...
def _test_interfaces():
    ...
    # Production test
    print("Production get_johnsongrass")
    start_time = _default_timer()
    result = get_johnsongrass()
