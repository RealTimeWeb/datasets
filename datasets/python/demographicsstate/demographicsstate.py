...
class _Constants(object):
    ...
    '''
    _HEADER = {'User-Agent': 
              'CORGIS Demographics State library for educational purposes'}
...
_Constants._DATABASE_NAME = "demographicsstate.db"
...
def _test_interfaces():
    ...
    result = get_all_states(test=False)
