...
_Constants._DATABASE_NAME = "globaldevelopment.db"
...
def get_reports_by_country(country, test=True):
    """
...
def _test_interfaces():
    ...
    start_time = _default_timer()
    result = get_reports_by_country("'Afghanistan'", test=False)
