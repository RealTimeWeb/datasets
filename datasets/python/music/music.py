...
def _tifa_definitions():
    return {"type": "ModuleType",
		...
		{"type": "ListType", "subtype": 
			{"type": "DictType", "literals": [{"type": "LiteralStr", "value": 'release'}, {"type": "LiteralStr", "value": 'artist'}, {"type": "LiteralStr", "value": 'song'}], "values": [
				{"type": "DictType", "literals": [{"type": "LiteralStr", "value": 'id'}, {"type": "LiteralStr", "value": 'name'}], "values": [
					{"type": "NumType"}, 
					{"type": "NumType"}]}, 
				{"type": "DictType", "literals": [{"type": "LiteralStr", "value": 'terms'}, {"type": "LiteralStr", "value": 'latitude'}, {"type": "LiteralStr", "value": 'id'}, {"type": "LiteralStr", "value": 'name'}, {"type": "LiteralStr", "value": 'longitude'}, {"type": "LiteralStr", "value": 'familiarity'}, {"type": "LiteralStr", "value": 'location'}, {"type": "LiteralStr", "value": 'similar'}, {"type": "LiteralStr", "value": 'hotttnesss'}, {"type": "LiteralStr", "value": 'terms_freq'}], "values": [
					{"type": "StrType"}, 
					{"type": "NumType"}, 
					{"type": "StrType"}, 
					{"type": "StrType"}, 
					...
					{"type": "NumType"}, 
					{"type": "NumType"}]}, 
				{"type": "DictType", "literals": [{"type": "LiteralStr", "value": 'artist_mbtags_count'}, {"type": "LiteralStr", "value": 'id'}, {"type": "LiteralStr", "value": 'tempo'}, {"type": "LiteralStr", "value": 'duration'}, {"type": "LiteralStr", "value": 'hotttnesss'}, {"type": "LiteralStr", "value": 'tatums_start'}, {"type": "LiteralStr", "value": 'beats_confidence'}, {"type": "LiteralStr", "value": 'artist_mbtags'}, {"type": "LiteralStr", "value": 'mode'}, {"type": "LiteralStr", "value": 'loudness'}, {"type": "LiteralStr", "value": 'time_signature_confidence'}, {"type": "LiteralStr", "value": 'time_signature'}, {"type": "LiteralStr", "value": 'bars_start'}, {"type": "LiteralStr", "value": 'end_of_fade_in'}, {"type": "LiteralStr", "value": 'bars_confidence'}, {"type": "LiteralStr", "value": 'start_of_fade_out'}, {"type": "LiteralStr", "value": 'mode_confidence'}, {"type": "LiteralStr", "value": 'year'}, {"type": "LiteralStr", "value": 'title'}, {"type": "LiteralStr", "value": 'key'}, {"type": "LiteralStr", "value": 'tatums_confidence'}, {"type": "LiteralStr", "value": 'beats_start'}, {"type": "LiteralStr", "value": 'key_confidence'}], "values": [
					{"type": "NumType"}, 
					{"type": "StrType"}, 
					{"type": "NumType"}, 
					{"type": "NumType"}, 
