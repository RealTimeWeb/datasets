...
class _Constants(object):
    ...
    '''
    _HEADER = {'User-Agent': 
              'CORGIS Horse Racing library for educational purposes'}
...
_Constants._DATABASE_NAME = "horse_racing.db"
...
def get_races():
    ...
    if False:
        ...
        rows = _Constants._DATABASE.execute("SELECT data FROM races".format(
