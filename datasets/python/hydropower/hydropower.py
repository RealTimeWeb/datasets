...
class _Constants(object):
    ...
    '''
    _HEADER = {'User-Agent': 
              'CORGIS Hydropower library for educational purposes'}
...
_Constants._DATABASE_NAME = "hydropower.db"
...
def get_dams():
    ...
    if False:
        ...
        rows = _Constants._DATABASE.execute("SELECT data FROM hydropower".format(
