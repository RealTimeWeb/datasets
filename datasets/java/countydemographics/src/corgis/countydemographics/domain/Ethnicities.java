...
public class Ethnicities {
    ...
    private Double whiteAlone,NotHispanicOrLatino;
     ...
     * @return 
     */
    public Double getWhiteAlone,NotHispanicOrLatino() {
        return this.whiteAlone,NotHispanicOrLatino;
    }
	...
	public String toString() {
		return "Ethnicities[" +whiteAlone,NotHispanicOrLatino+", "+twoOrMoreRaces+", "+asianAlone+", "+nativeHawaiianAndOtherPacificIslanderAlone+", "+whiteAlone+", "+hispanicOrLatino+", "+blackAlone+", "+americanIndianAndAlaskaNativeAlone+"]";
	}
    ...
    public Ethnicities(JSONObject json_data) {
        try {// White Alone, not Hispanic or Latino
            this.whiteAlone,NotHispanicOrLatino = (Double)json_data.get("White Alone, not Hispanic or Latino");// Two or More Races
