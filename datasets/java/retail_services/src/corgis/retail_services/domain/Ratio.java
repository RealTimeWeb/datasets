...
public class Ratio {
    ...
    private Double departmentStoresExclLD;
     ...
     * @return 
     */
    public Double getDepartmentStoresExclLD() {
    ...
    public Ratio(JSONObject json_data) {
        try {// floor covering stores
            ...
            this.departmentStoresExclLD = ((Number)((JSONObject) ((JSONObject) ((JSONObject) json_data.get("department stores (excl")).get(" l")).get("d")).get(")")).doubleValue();// limited service eating places
            ...
            this.buildingMatAndGardenEquipAndSuppliesDealers = ((Number)((JSONObject) ((JSONObject) json_data.get("building mat")).get(" and garden equip")).get(" and supplies dealers")).doubleValue();// furniture and home furnishings stores
            ...
            this.drinkingPlaces = ((Number)json_data.get("drinking places")).intValue();// other general merchandise stores
            this.otherGeneralMerchandiseStores = ((Number)json_data.get("other general merchandise stores")).intValue();// home furnishings stores
            this.homeFurnishingsStores = ((Number)json_data.get("home furnishings stores")).intValue();// hardware stores
            this.hardwareStores = ((Number)json_data.get("hardware stores")).intValue();// auto and other motor vehicles
            this.autoAndOtherMotorVehicles = ((Number)json_data.get("auto and other motor vehicles")).intValue();// food and beverage stores
            this.foodAndBeverageStores = ((Number)json_data.get("food and beverage stores")).doubleValue();// men's clothing stores
            ...
            this.furnitureHomeFurnElectronicsAndApplianceStores = ((Number)json_data.get("furniture, home furn, electronics, and appliance stores")).doubleValue();// gasoline stations
            ...
            this.generalMerchandiseStores = ((Number)json_data.get("general merchandise stores")).doubleValue();// motor vehicle and parts dealers
            this.motorVehicleAndPartsDealers = ((Number)json_data.get("motor vehicle and parts dealers")).doubleValue();// new car dealers
            ...
            this.retailTrade = ((Number)json_data.get("retail trade")).doubleValue();// beer, wine, and liquor stores
            ...
            this.retailTradeExAuto = ((Number)json_data.get("retail trade, ex auto")).doubleValue();// clothing and clothing access. stores
            this.clothingAndClothingAccessStores = ((Number)((JSONObject) json_data.get("clothing and clothing access")).get(" stores")).doubleValue();// retail trade and food services, ex auto
