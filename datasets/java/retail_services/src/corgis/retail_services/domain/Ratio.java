...
public class Ratio {
    ...
    public Ratio(JSONObject json_data) {
        try {// floor covering stores
            ...
            this.motorVehicleAndPartsDealers = ((Number)json_data.get("motor vehicle and parts dealers")).doubleValue();// all other merchandise stores
            ...
            this.nonLeasedDepartmentStores = ((Number)json_data.get("non-leased department stores")).doubleValue();// furniture and home furnishings stores
            ...
            this.retailTradeExAuto = ((Number)json_data.get("retail trade, ex auto")).doubleValue();// gift, novelty, and souvenir stores
            ...
            this.retailTrade = ((Number)json_data.get("retail trade")).doubleValue();// building materials and garden supplies dealers
            this.buildingMaterialsAndGardenSuppliesDealers = ((Number)json_data.get("building materials and garden supplies dealers")).doubleValue();// supermarkets and other grocery (except convenience) stores
            ...
            this.clothingStores = ((Number)json_data.get("clothing stores")).doubleValue();// used car dealers
