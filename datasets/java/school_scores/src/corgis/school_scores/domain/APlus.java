...
public class APlus {
    ...
    public APlus(JSONObject json_data) {
        try {// Math
    		...
    		System.err.println("Could not convert the response to a APlus; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a APlus; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}