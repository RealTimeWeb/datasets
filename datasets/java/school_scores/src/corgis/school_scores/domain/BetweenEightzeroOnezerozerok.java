...
public class BetweenEightzeroOnezerozerok {
    ...
    public BetweenEightzeroOnezerozerok(JSONObject json_data) {
        try {// Math
    		...
    		System.err.println("Could not convert the response to a Between80-100K; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Between80-100K; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}