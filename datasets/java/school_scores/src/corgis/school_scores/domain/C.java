...
public class C {
    ...
    public C(JSONObject json_data) {
        try {// Math
    		...
    		System.err.println("Could not convert the response to a C; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a C; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}