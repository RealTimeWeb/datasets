...
public class Employed {
    ...
    public Employed(JSONObject json_data) {
        try {// White
    		...
    		System.err.println("Could not convert the response to a Employed; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Employed; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}