...
public class Artwork {
    ...
    public Artwork(JSONObject json_data) {
        try {// artist
    		...
    		System.err.println("Could not convert the response to a Artwork; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Artwork; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}