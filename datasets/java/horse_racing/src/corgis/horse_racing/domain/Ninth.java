...
public class Ninth {
	...
	/**
	 * Creates a string based representation of this Ninth.
	
	 * @return String
	 */
	public String toString() {
		return "Ninth[" +scratched+", "+alsoRans+", "+trifecta+", "+secondPlace+", "+exacta+", "+dailyDouble+", "+superfecta+", "+firstPlace+", "+thirdPlace+"]";
	}
	
	/**
	 * Internal constructor to create a Ninth from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Ninth(JSONObject json_data) {
        try {// scratched
            ...
            this.superfecta = (String)json_data.get("superfecta");// first place
    		...
    		System.err.println("Could not convert the response to a Ninth; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Ninth; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}