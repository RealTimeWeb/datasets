...
public class Eighth {
	...
	/**
	 * Creates a string based representation of this Eighth.
	
	 * @return String
	 */
	public String toString() {
		return "Eighth[" +scratched+", "+alsoRans+", "+trifecta+", "+secondPlace+", "+exacta+", "+dailyDouble+", "+superfecta+", "+firstPlace+", "+thirdPlace+"]";
	}
	
	/**
	 * Internal constructor to create a Eighth from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Eighth(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a Eighth; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Eighth; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}