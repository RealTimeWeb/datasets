...
public class Oneone {
	...
	/**
	 * Creates a string based representation of this 11.
	
	 * @return String
	 */
	public String toString() {
		return "11[" +scratched+", "+alsoRans+", "+trifecta+", "+third+", "+daily_Double+", "+exacta+", "+second+", "+superfecta+", "+first+"]";
	}
	
	/**
	 * Internal constructor to create a 11 from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Oneone(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a 11; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a 11; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}