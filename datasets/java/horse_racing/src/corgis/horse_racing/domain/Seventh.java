...
public class Seventh {
	...
	/**
	 * Creates a string based representation of this Seventh.
	
	 * @return String
	 */
	public String toString() {
		return "Seventh[" +scratched+", "+alsoRans+", "+trifecta+", "+secondPlace+", "+exacta+", "+dailyDouble+", "+superfecta+", "+firstPlace+", "+thirdPlace+"]";
	}
	
	/**
	 * Internal constructor to create a Seventh from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Seventh(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a Seventh; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Seventh; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}