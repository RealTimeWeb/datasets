...
public class Tenth {
	...
	/**
	 * Creates a string based representation of this Tenth.
	
	 * @return String
	 */
	public String toString() {
		return "Tenth[" +scratched+", "+alsoRans+", "+trifecta+", "+secondPlace+", "+exacta+", "+dailyDouble+", "+superfecta+", "+firstPlace+", "+thirdPlace+"]";
	}
	
	/**
	 * Internal constructor to create a Tenth from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Tenth(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a Tenth; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Tenth; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}