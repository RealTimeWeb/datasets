...
public class Sixth {
	...
	/**
	 * Creates a string based representation of this Sixth.
	
	 * @return String
	 */
	public String toString() {
		return "Sixth[" +scratched+", "+alsoRans+", "+trifecta+", "+secondPlace+", "+exacta+", "+dailyDouble+", "+superfecta+", "+firstPlace+", "+thirdPlace+"]";
	}
	
	/**
	 * Internal constructor to create a Sixth from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Sixth(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a Sixth; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Sixth; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}