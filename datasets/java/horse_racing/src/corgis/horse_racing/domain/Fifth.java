...
public class Fifth {
	...
	/**
	 * Creates a string based representation of this Fifth.
	
	 * @return String
	 */
	public String toString() {
		return "Fifth[" +scratched+", "+alsoRans+", "+trifecta+", "+secondPlace+", "+exacta+", "+dailyDouble+", "+superfecta+", "+firstPlace+", "+thirdPlace+"]";
	}
	
	/**
	 * Internal constructor to create a Fifth from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Fifth(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a Fifth; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Fifth; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}