...
public class Onezero {
	...
	/**
	 * Creates a string based representation of this 10.
	
	 * @return String
	 */
	public String toString() {
		return "10[" +scratched+", "+alsoRans+", "+trifecta+", "+third+", "+daily_Double+", "+exacta+", "+second+", "+superfecta+", "+first+"]";
	}
	
	/**
	 * Internal constructor to create a 10 from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Onezero(JSONObject json_data) {
        try {// scratched
    		...
    		System.err.println("Could not convert the response to a 10; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a 10; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}