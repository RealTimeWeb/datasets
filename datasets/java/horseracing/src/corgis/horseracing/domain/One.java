...
public class One {
    ...
    private ArrayList<Scratched> scratched;
    private ArrayList<AlsoRans> alsoRans;
    private Trifecta trifecta;
    private Third third;
    private String daily_Double;
     ...
     * @return 
     */
    public ArrayList<Scratched> getScratched() {
	...
	/**
	 * Creates a string based representation of this 1.
	
	 * @return String
	 */
	public String toString() {
		return "1[" +scratched+", "+alsoRans+", "+trifecta+", "+third+", "+daily_Double+", "+exacta+", "+second+", "+superfecta+", "+first+"]";
	}
	
	/**
	 * Internal constructor to create a 1 from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public One(JSONObject json_data) {
        try {// scratched
            this.scratched = new ArrayList<Scratched>();
            Iterator<Object> scratchedIter = ((List<Object>)json_data.get("scratched")).iterator();
            while (scratchedIter.hasNext()) {
                this.scratched.add(new Scratched((JSONObject)scratchedIter.next()));
            }// also-rans
            ...
            this.daily_Double = (String)json_data.get("daily_double");// exacta
    		...
    		System.err.println("Could not convert the response to a 1; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a 1; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}