...
public class RickSantorum {
	...
	/**
	 * Creates a string based representation of this RickSantorum.
	
	 * @return String
	 */
	public String toString() {
		return "RickSantorum[" +party+", "+numberOfVotes+", "+percentOfVotes+"]";
	}
	
	/**
	 * Internal constructor to create a RickSantorum from a  representation.
