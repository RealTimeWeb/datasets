...
public class JebBush {
    ...
    public JebBush(JSONObject json_data) {
        try {// Party
    		...
    		System.err.println("Could not convert the response to a JebBush; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a JebBush; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}