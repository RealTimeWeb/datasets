...
public class Public_ {
	...
	public String toString() {
		return "Public[" +sewageAndWasteDisposal+", "+communication+", "+highwayAndStreet+", "+manufacturing+", "+office+", "+waterSupply+", "+religious+", "+conservationAndDevelopment+", "+healthCare+", "+lodging+", "+transportation+", "+totalConstruction+", "+educational+", "+power+", "+commercial+", "+nonresidential+", "+publicSafety+", "+residential+", "+amusementAndRecreation+"]";
	}
