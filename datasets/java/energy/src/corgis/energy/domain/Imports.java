...
public class Imports {
	...
	/**
	 * Creates a string based representation of this Imports.
	
	 * @return String
	 */
	public String toString() {
		return "Imports[" +crudeOil+", "+petroleumProducts+", "+naturalGas+", "+electricity+", "+coalCoke+", "+coal+", "+total+", "+totalPetroleum+", "+biofuels+"]";
	}
	
	/**
	 * Internal constructor to create a Imports from a  representation.
	 * @param json_data The raw json data that will be parsed.
	 */
    public Imports(JSONObject json_data) {
        try {// crude oil
    		...
    		System.err.println("Could not convert the response to a Imports; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Imports; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}