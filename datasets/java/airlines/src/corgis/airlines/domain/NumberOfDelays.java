...
public class NumberOfDelays {
    ...
    public NumberOfDelays(JSONObject json_data) {
        try {// late aircraft
            ...
            this.weather = new Integer(((Long)json_data.get("weather")).intValue());// security
            this.security = new Integer(((Long)json_data.get("security")).intValue());// national aviation system
            this.nationalAviationSystem = new Integer(((Long)json_data.get("national aviation system")).intValue());// carrier
            this.carrier = new Integer(((Long)json_data.get("carrier")).intValue());
