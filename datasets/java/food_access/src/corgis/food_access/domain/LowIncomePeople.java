...
public class LowIncomePeople {
	...
	/**
	 * Creates a string based representation of this LowIncomePeople.
	
	 * @return String
	 */
	public String toString() {
		return "LowIncomePeople[" +twozeroMiles+", "+oneTwoMile+", "+oneMile+", "+onezeroMiles+"]";
	}
	
	/**
	 * Internal constructor to create a LowIncomePeople from a  representation.
