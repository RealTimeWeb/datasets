...
public class People {
    ...
    public People(JSONObject json_data) {
        try {// 20 Miles
    		...
    		System.err.println("Could not convert the response to a People; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a People; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}