...
public class Writing {
    ...
    public Writing(JSONObject json_data) {
        try {// grade
    		...
    		System.err.println("Could not convert the response to a Writing; a field was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Writing; a field had the wrong structure.");
    		e.printStackTrace();
        }
	}	
}