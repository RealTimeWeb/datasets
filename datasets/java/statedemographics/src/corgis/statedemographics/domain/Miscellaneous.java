...
public class Miscellaneous {
    ...
    // percent, 2009-2013
    private Double livingInSameHouse+OneYears;
     ...
     * @return 
     */
    public Double getLivingInSameHouse+OneYears() {
        return this.livingInSameHouse+OneYears;
    }
	...
	public String toString() {
		return "Miscellaneous[" +manufacturersShipments+", "+foreignBorn+", "+percentFemale+", "+languageOtherThanEnglishAtHome+", "+livingInSameHouse+OneYears+", "+meanTravelTimeToWork+", "+buildingPermits+", "+veterans+", "+landArea+"]";
	}
    ...
    public Miscellaneous(JSONObject json_data) {
        try {// Manufacturers Shipments
            ...
            this.livingInSameHouse+OneYears = (Double)json_data.get("Living in Same House +1 Years");// Mean Travel Time to Work
