...
public class Utilities {
	...
	public String toString() {
		return "Utilities[" +transitUtilityTotalExpenditure+", "+utilitiesEquipmentAndLand+", "+utilitiesTotalExpenditure+", "+utilitiesCurrentOperation+", "+waterUtilityTotalExpenditure+", "+gasUtilityTotalExpenditure+", "+utilitiesConstruction+", "+electricUtilityTotalExpenditure+", "+utilitiesInterestTotal+"]";
	}
